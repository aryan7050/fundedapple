...
router.post('/upload-document', requireAuth, (req, res, next) => {
...
router.post('/submit', requireAuth, async (req, res) => {
    try {
        const { dateOfBirth, addressLine1, city, stateProvince, postalCode, idDocumentType, idDocumentNumber, } = req.body ?? {};
